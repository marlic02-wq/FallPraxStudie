...
\begin{itemize}
    ...
    \textit{Zur feingranularen Bewertung unterteilt sich dieses Kriterium in die Aspekte Projektanlage \& Tool-Start (40\,\%), Debugging \& Ausführung (30\,\%) sowie \gls{ci}/Reporting-Anschlussfähigkeit (30\,\%).}
    ...
    \textit{Hierbei werden die lokale Ausführungsgeschwindigkeit (60\,\%) und die theoretische Skalierbarkeit in einer \gls{ci}-Pipeline (40\,\%) betrachtet.}

    \item \textbf{Stabilität (20\,\%):} Konsistente Stabilität der Tests zur Minimierung von \textit{\gls{flakytest}s}.\\
