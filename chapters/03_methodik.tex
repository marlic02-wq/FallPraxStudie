...
\begin{itemize}
    ...
    \item \textbf{Test-Ausführung und Debugging (20\,\%):} Analyse der Ausführungsgeschwindigkeit und der Möglichkeiten zur Fehlersuche.
    \item \textbf{Stabilität (20\,\%):} Zuverlässigkeit der Tests (Minimierung von \textit{Flaky Tests}). Laufzeit und Stabilität bestimmen direkt den Erfolg der täglichen Qualitätssicherung.
    \item \textbf{Dokumentation und Ökosystem (15\,\%):} Bewertung der offiziellen Hilfen und Community. Dies flankiert den Entwicklungsprozess, ist den technischen Kernaspekten jedoch untergeordnet.
\end{itemize}
