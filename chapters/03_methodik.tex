...
\begin{itemize}
    ...
    \item \textbf{Stabilität (20\,\%):} Zuverlässigkeit der Tests zur Minimierung von \textit{Flaky Tests}. Laufzeit und Stabilität bestimmen direkt den Erfolg der täglichen Qualitätssicherung.\\
...
Nach Abschluss der Implementierung werden die erhobenen Daten in das Kriterienmodell überführt. Jedes Framework erhält pro Kriterium eine Bewertung auf einer festen \textbf{Skala von 1 bis 10 Punkten}. Diese Punktzahl wird mit der zuvor definierten Gewichtung multipliziert. Die Summe aller gewichteten Punkte ergibt den Gesamtnutzwert.