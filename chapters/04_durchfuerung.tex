...
Dieses Unterkapitel beschreibt die getesteten Anwendungsszenarien systematisch und ordnet diese den jeweiligen Testimplementierungen zu.
...
Das erwartete Ergebnis ist, dass der Benutzer erfolgreich angemeldet wird und der Redirect im Test validiert wird.\footnote{\textbf{Testdateien:} Selenium: \path{.../_01_PumaLoginTest.java} | Cypress: \path{.../01_login-ui.cy.js}}
...
Als erwartetes Ergebnis wird das Projekt oder die Aktivität erfolgreich angelegt. Die Anwendung zeigt eine korrekte Bestätigung an, und die Daten sind im System vorhanden.\footnote{\textbf{Testdateien:} Selenium: \path{.../_02_NewActivityAnlegenTest.java} \& \path{.../_02_NewProjektTest.java} | Cypress: \path{.../02_newActivity.cy.js} \& \path{.../02_newProjekt.cy.js}}
...
Es wird erwartet, dass die Aktivität erfolgreich gespeichert wird und die geänderten Werte korrekt in der Oberfläche angezeigt werden.\footnote{\textbf{Testdateien:} Selenium: \path{.../_03_EditActivityTest.java} \& \path{.../_03_ControlEditedActivityTest.java} | Cypress: \path{.../03_editActivity.cy.js} \& \path{.../03_controlEditedActivity.cy.js}}
