\begin{titlepage}
    \begin{center}
      ...
      {\LARGE \textbf{Praxisorientierte Fallstudie:}}\\[0.6cm]
        ...
        {\Large \textbf{Nutzwertanalyse von End-to-End-Test-Frameworks (Selenium vs. Cypress) für die Automatisierung repräsentativer regressionskritischer Testszenarien zur Reduzierung des manuellen Testaufwands}}\\[1.5cm]
